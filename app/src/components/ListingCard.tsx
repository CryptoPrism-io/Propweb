  ...
  return (
    ...
    >
      <div className="relative">
        <img src={listing.photos[0]} alt={listing.title} className="h-[186px] w-full object-cover" />
      ...
      <div className="pt-[14px] px-[15px] pb-[15px]">
        ...
        <div className="mt-3 flex flex-wrap gap-2 text-xs text-coolgrey">
          <span className="inline-flex items-center gap-1 rounded-full border border-line px-[11px] py-[5px] font-semibold"><Ruler size={15} /> {listing.areaSqft} sq.ft</span>
          <span className="inline-flex items-center gap-1 rounded-full border border-line px-[11px] py-[5px] font-semibold"><Bed size={15} /> {listing.bhk} BHK</span>
          <span className="inline-flex items-center gap-1 rounded-full border border-line px-[11px] py-[5px] font-semibold"><Armchair size={15} /> {FURNISH_LABEL[listing.furnishing]}</span>
        </div>
